...
# Database: stickease
# Generation Time: 2011-10-20 22:57:37 -0400
# ************************************************************
...
CREATE TABLE `stickys` (
  ...
  `sticky_note` varchar(255) NOT NULL DEFAULT '',
  `sticky_created` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `sticky_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `user_id_created` int(11) unsigned NOT NULL,
  `user_id_assigned` int(11) unsigned NOT NULL,
  `sticky_priority` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `sticky_order` smallint(5) unsigned NOT NULL,
