...
<section id="header_wrapper">
	<header>
		...
		<div class="info">
			<ul class="clearfix">
				<li><select>
					<option selected="selected" value="1">james wagoner (me)</option>
					<option value="">all</option>
					<option>jimmy thomas</option>
					<option>bryan conzone</option>
				</select></li>
				<li><select>
					<option selected="selected">DealerNinja.com - Homepage</option>
					<option>DN.com - </option>
					<option>DealerNinja.com</option>
				</select></li>
